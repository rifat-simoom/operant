...
**Goal:** Reinforce the launch with one concrete, specific differentiator: **git worktree per task**.
...
**Status:** ready (publish ~T+5 days after launch)
...
Operant does this automatically for every task: github.com/rifat-simoom/operant
...
Operant bunu her task için otomatik yapıyor: github.com/rifat-simoom/operant
